...
async function openUserPage() {
    ...
    try {
        ...
        // 3. 🔥 ABRE A PÁGINA (ADICIONA CLASSE)
        ...
        // 7. CARREGA DATA DE CRIAÇÃO
        await loadUserJoinDate();
...
// ============================================
// FECHAR PÁGINA DO USUÁRIO (CORRIGIDO)
// ============================================
