...
// ============================================
// ============================================
// PÁGINA DO USUÁRIO - VERSÃO IFRAME
// ============================================
// ============================================
    ...
    if (event.data && event.data.type) {
        switch(event.data.type) {
            case 'openSubcollection':
                if (event.data.uid) {
                    console.log('📂 Abrindo subcoleção:', event.data.uid);
                    openSubcollection(event.data.uid);
                }
                break;
            case 'openArticle':
                if (event.data.collectionUid && event.data.articleId) {
                    console.log('📄 Abrindo artigo:', event.data.articleId);
                    openArticle(event.data.collectionUid, event.data.articleId);
                }
                break;
            case 'closeUserPage':
                console.log('🚪 Fechando página do usuário via iframe');
                closeUserPage();
                break;
            case 'showLogin':
...
console.log('👤 Página do usuário com IFRAME ativa!');
